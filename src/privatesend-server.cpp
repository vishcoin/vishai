...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Vishai related functionality
...
/*
    ...
    allow endless transaction that would bloat Vishai and make it unusable. To
