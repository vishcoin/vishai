...
static const int MASTERNODE_MIN_MNP_SECONDS             =  10 * 60; // kampret
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 1000000 VISH - checking if valid masternode)
