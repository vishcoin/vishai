/* src/config/vishai-config.h.  Generated from vishai-config.h.in by configure.  */
/* src/config/vishai-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef VISH_CONFIG_H

#define VISH_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/vishcoin/vishai/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Vishai Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Vishai Core 1.2.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "vishaicore"
