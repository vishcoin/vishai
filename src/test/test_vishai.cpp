...
#define BOOST_TEST_MODULE Vishai Test Suite

#include "test_vishai.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_vishai_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
