    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("VISH-Tan"), QVariant("light"));
    ui->theme->addItem(QString("VISH-Black"), QVariant("drkblue"));
    ui->theme->addItem(QString("VISH-Blue"), QVariant("crownium"));
    ui->theme->addItem(QString("VISH-Chocolate"), QVariant("trad"));
    /* Language selector */
