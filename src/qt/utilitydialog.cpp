    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Vishai Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Vishai Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  vishai-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Vishai in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Vishai Core is shutting down...") + "<br /><br />" +
