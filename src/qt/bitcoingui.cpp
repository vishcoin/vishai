    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Vishai Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Vishai address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and vishai: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Vishai Core"), this);
    aboutAction->setStatusTip(tr("Show information about Vishai Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Vishai Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Vishai addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Vishai addresses"));
    ...
    openAction->setStatusTip(tr("Open a vishai: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Vishai Core help message to get a list with possible Vishai Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Vishai Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Vishai network", "", count));
    } else {
...
{
    QString strTitle = tr("Vishai Core"); // default title
