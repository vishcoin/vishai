...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "VishaiNetwork") type = VishaiNetwork;
    if(strType == "VishaiNetworkVariable") type = VishaiNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == VishaiNetwork) s = "VishaiNetwork";
    if(type == VishaiNetworkVariable) s = "VishaiNetworkVariable";
