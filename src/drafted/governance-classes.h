 ...
 *
 *   // network
 *   CVishaiNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.vishai.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CVishaiNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: VishaiNetwork
// //   -- signature requirements : Key1(User)
// class CVishaiNetworkVariable : public CGovernanceObject
// {
// private:
