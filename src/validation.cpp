...
#if defined(NDEBUG)
# error "Vishai Core cannot be compiled without assertions."
#endif
...
CAmount GetBlockSubsidy(int nPrevBits, int nPrevHeight, const Consensus::Params& consensusParams, bool fSuperblockPartOnly)
{
    ...
    if(nPrevHeight < 20160) {
		nSubsidyBase = 5000;
            ...
            if ((nPrevHeight >= 20160) && (nPrevHeight < 40320)) nSubsidyBase = 4750;
            if ((nPrevHeight >= 40320) && (nPrevHeight < 60480)) nSubsidyBase = 4512;
            if ((nPrevHeight >= 60480) && (nPrevHeight < 80640)) nSubsidyBase = 4286;
            if ((nPrevHeight >= 80640) && (nPrevHeight < 100800)) nSubsidyBase = 4071;
            if ((nPrevHeight >= 100800) && (nPrevHeight < 120960)) nSubsidyBase = 3867;
            if ((nPrevHeight >= 120960) && (nPrevHeight < 141120)) nSubsidyBase = 3673;
            if ((nPrevHeight >= 141120) && (nPrevHeight < 161280)) nSubsidyBase = 3489;
            if ((nPrevHeight >= 161280) && (nPrevHeight < 181440)) nSubsidyBase = 3314;
            if ((nPrevHeight >= 181440) && (nPrevHeight < 201600)) nSubsidyBase = 3148;
            if ((nPrevHeight >= 201600) && (nPrevHeight < 221760)) nSubsidyBase = 2990;
            if ((nPrevHeight >= 221760) && (nPrevHeight < 241920)) nSubsidyBase = 2840;
            if ((nPrevHeight >= 241920) && (nPrevHeight < 262080)) nSubsidyBase = 2698;
            if ((nPrevHeight >= 262080) && (nPrevHeight < 282240)) nSubsidyBase = 2563;
            if ((nPrevHeight >= 282240) && (nPrevHeight < 302400)) nSubsidyBase = 2434;
            if ((nPrevHeight >= 302400) && (nPrevHeight < 322560)) nSubsidyBase = 2312;
            if ((nPrevHeight >= 322560) && (nPrevHeight < 342720)) nSubsidyBase = 2196;
            if ((nPrevHeight >= 342720) && (nPrevHeight < 362880)) nSubsidyBase = 2086;
            if ((nPrevHeight >= 362880) && (nPrevHeight < 383040)) nSubsidyBase = 1981;
            if ((nPrevHeight >= 383040) && (nPrevHeight < 403200)) nSubsidyBase = 1881;
            if ((nPrevHeight >= 403200) && (nPrevHeight < 423360)) nSubsidyBase = 1786;
            if ((nPrevHeight >= 423360) && (nPrevHeight < 443520)) nSubsidyBase = 1696;
            if ((nPrevHeight >= 443520) && (nPrevHeight < 463680)) nSubsidyBase = 1611;
            if ((nPrevHeight >= 463680) && (nPrevHeight < 483840)) nSubsidyBase = 1530;
            if ((nPrevHeight >= 483840) && (nPrevHeight < 504000)) nSubsidyBase = 1453;
            if ((nPrevHeight >= 504000) && (nPrevHeight < 524160)) nSubsidyBase = 1380;
            if ((nPrevHeight >= 524160) && (nPrevHeight < 544320)) nSubsidyBase = 1311;
            if ((nPrevHeight >= 544320) && (nPrevHeight < 564480)) nSubsidyBase = 1245;
            if ((nPrevHeight >= 564480) && (nPrevHeight < 584640)) nSubsidyBase = 1182;
            if ((nPrevHeight >= 584640) && (nPrevHeight < 604800)) nSubsidyBase = 1122;
            if ((nPrevHeight >= 604800) && (nPrevHeight < 624960)) nSubsidyBase = 1065;
            if ((nPrevHeight >= 624960) && (nPrevHeight < 645120)) nSubsidyBase = 1011;
            if ((nPrevHeight >= 645120) && (nPrevHeight < 665280)) nSubsidyBase = 960;
            if ((nPrevHeight >= 665280) && (nPrevHeight < 685440)) nSubsidyBase = 912;
            if ((nPrevHeight >= 685440) && (nPrevHeight < 705600)) nSubsidyBase = 866;
            if ((nPrevHeight >= 705600) && (nPrevHeight < 725760)) nSubsidyBase = 822;
            if ((nPrevHeight >= 725760) && (nPrevHeight < 745920)) nSubsidyBase = 780;
            if ((nPrevHeight >= 745920) && (nPrevHeight < 766080)) nSubsidyBase = 741;
            if ((nPrevHeight >= 766080) && (nPrevHeight < 786240)) nSubsidyBase = 703;
            if ((nPrevHeight >= 786240) && (nPrevHeight < 806400)) nSubsidyBase = 667;
            if ((nPrevHeight >= 806400) && (nPrevHeight < 826560)) nSubsidyBase = 633;
            if ((nPrevHeight >= 826560) && (nPrevHeight < 846720)) nSubsidyBase = 601;
            if ((nPrevHeight >= 846720) && (nPrevHeight < 866880)) nSubsidyBase = 570;
            if ((nPrevHeight >= 866880) && (nPrevHeight < 887040)) nSubsidyBase = 541;
            if ((nPrevHeight >= 887040) && (nPrevHeight < 907200)) nSubsidyBase = 513;
            if ((nPrevHeight >= 907200) && (nPrevHeight < 927360)) nSubsidyBase = 487;
            if ((nPrevHeight >= 927360) && (nPrevHeight < 947520)) nSubsidyBase = 462;
            if ((nPrevHeight >= 947520) && (nPrevHeight < 967680)) nSubsidyBase = 438;
            if ((nPrevHeight >= 967680) && (nPrevHeight < 987840)) nSubsidyBase = 416;
            if ((nPrevHeight >= 987840) && (nPrevHeight < 1008000)) nSubsidyBase = 395;
            if ((nPrevHeight >= 1008000) && (nPrevHeight < 1028160)) nSubsidyBase = 375;
            if ((nPrevHeight >= 1028160) && (nPrevHeight < 1048320)) nSubsidyBase = 356;
            if ((nPrevHeight >= 1048320) && (nPrevHeight < 1068480)) nSubsidyBase = 338;
            if ((nPrevHeight >= 1068480) && (nPrevHeight < 1088640)) nSubsidyBase = 321;
            if ((nPrevHeight >= 1088640) && (nPrevHeight < 1108800)) nSubsidyBase = 304;
            if ((nPrevHeight >= 1108800) && (nPrevHeight < 1128960)) nSubsidyBase = 288;
            if ((nPrevHeight >= 1128960) && (nPrevHeight < 1149120)) nSubsidyBase = 273;
            if ((nPrevHeight >= 1149120) && (nPrevHeight < 1169280)) nSubsidyBase = 259;
            if ((nPrevHeight >= 1169280) && (nPrevHeight < 1189440)) nSubsidyBase = 246;
            if ((nPrevHeight >= 1189440) && (nPrevHeight < 1209600)) nSubsidyBase = 233;
            if ((nPrevHeight >= 1209600) && (nPrevHeight < 1229760)) nSubsidyBase = 221;
            if ((nPrevHeight >= 1229760) && (nPrevHeight < 1249920)) nSubsidyBase = 209;
            if ((nPrevHeight >= 1249920) && (nPrevHeight < 1270080)) nSubsidyBase = 198;
            if ((nPrevHeight >= 1270080) && (nPrevHeight < 1290240)) nSubsidyBase = 188;
            if ((nPrevHeight >= 1290240) && (nPrevHeight < 1310400)) nSubsidyBase = 178;
            if ((nPrevHeight >= 1310400) && (nPrevHeight < 1330560)) nSubsidyBase = 169;
            if ((nPrevHeight >= 1330560) && (nPrevHeight < 1350720)) nSubsidyBase = 160;
            if ((nPrevHeight >= 1350720) && (nPrevHeight < 1370880)) nSubsidyBase = 152;
            if ((nPrevHeight >= 1370880) && (nPrevHeight < 1391040)) nSubsidyBase = 144;
            if ((nPrevHeight >= 1391040) && (nPrevHeight < 1411200)) nSubsidyBase = 136;
            if ((nPrevHeight >= 1411200) && (nPrevHeight < 1431360)) nSubsidyBase = 129;
            if ((nPrevHeight >= 1431360) && (nPrevHeight < 1451520)) nSubsidyBase = 122;
            if ((nPrevHeight >= 1451520) && (nPrevHeight < 1471680)) nSubsidyBase = 115;
            if ((nPrevHeight >= 1471680) && (nPrevHeight < 1491840)) nSubsidyBase = 109;
            if ((nPrevHeight >= 1491840) && (nPrevHeight < 1512000)) nSubsidyBase = 103;
            if ((nPrevHeight >= 1512000) && (nPrevHeight < 1532160)) nSubsidyBase = 97;
            if ((nPrevHeight >= 1532160) && (nPrevHeight < 1552320)) nSubsidyBase = 92;
            if ((nPrevHeight >= 1552320) && (nPrevHeight < 1572480)) nSubsidyBase = 87;
            if ((nPrevHeight >= 1572480) && (nPrevHeight < 1592640)) nSubsidyBase = 82;
            if ((nPrevHeight >= 1592640) && (nPrevHeight < 1612800)) nSubsidyBase = 77;
            if ((nPrevHeight >= 1612800) && (nPrevHeight < 1632960)) nSubsidyBase = 73;
            if ((nPrevHeight >= 1632960) && (nPrevHeight < 1653120)) nSubsidyBase = 69;
            if ((nPrevHeight >= 1653120) && (nPrevHeight < 1673280)) nSubsidyBase = 65;
            if ((nPrevHeight >= 1673280) && (nPrevHeight < 1693440)) nSubsidyBase = 61;
            if ((nPrevHeight >= 1693440) && (nPrevHeight < 1713600)) nSubsidyBase = 57;
            if ((nPrevHeight >= 1713600) && (nPrevHeight < 1733760)) nSubsidyBase = 54;
            if ((nPrevHeight >= 1733760) && (nPrevHeight < 1753920)) nSubsidyBase = 51;
            if ((nPrevHeight >= 1753920) && (nPrevHeight < 1774080)) nSubsidyBase = 48;
            if ((nPrevHeight >= 1774080) && (nPrevHeight < 1794240)) nSubsidyBase = 45;
            if ((nPrevHeight >= 1794240) && (nPrevHeight < 1814400)) nSubsidyBase = 42;
            if ((nPrevHeight >= 1814400) && (nPrevHeight < 1834560)) nSubsidyBase = 39;
            if ((nPrevHeight >= 1834560) && (nPrevHeight < 1854720)) nSubsidyBase = 37;
            if ((nPrevHeight >= 1854720) && (nPrevHeight < 1874880)) nSubsidyBase = 35;
            if ((nPrevHeight >= 1874880) && (nPrevHeight < 1895040)) nSubsidyBase = 33;
            if ((nPrevHeight >= 1895040) && (nPrevHeight < 1915200)) nSubsidyBase = 31;
            if ((nPrevHeight >= 1915200) && (nPrevHeight < 1935360)) nSubsidyBase = 29;
            if ((nPrevHeight >= 1935360) && (nPrevHeight < 1955520)) nSubsidyBase = 27;
            if ((nPrevHeight >= 1955520) && (nPrevHeight < 1975680)) nSubsidyBase = 25;
            if ((nPrevHeight >= 1975680) && (nPrevHeight < 1995840)) nSubsidyBase = 23;
            if ((nPrevHeight >= 1995840) && (nPrevHeight < 2016000)) nSubsidyBase = 21;
            if ((nPrevHeight >= 2016000) && (nPrevHeight < 2036160)) nSubsidyBase = 19;
            if ((nPrevHeight >= 2036160) && (nPrevHeight < 2056320)) nSubsidyBase = 18;
            if ((nPrevHeight >= 2056320) && (nPrevHeight < 2076480)) nSubsidyBase = 17;
            if ((nPrevHeight >= 2076480) && (nPrevHeight < 2096640)) nSubsidyBase = 16;
            if ((nPrevHeight >= 2096640) && (nPrevHeight < 2116800)) nSubsidyBase = 15;
            if ((nPrevHeight >= 2116800) && (nPrevHeight < 2136960)) nSubsidyBase = 14;
            if ((nPrevHeight >= 2136960) && (nPrevHeight < 2157120)) nSubsidyBase = 13;
            if ((nPrevHeight >= 2157120) && (nPrevHeight < 2177280)) nSubsidyBase = 12;
            if ((nPrevHeight >= 2177280) && (nPrevHeight < 2197440)) nSubsidyBase = 11;
            if ((nPrevHeight >= 2197440) && (nPrevHeight < 2217600)) nSubsidyBase = 10;
            if ((nPrevHeight >= 2217600) && (nPrevHeight < 2237760)) nSubsidyBase = 9;
            if ((nPrevHeight >= 2237760) && (nPrevHeight < 2257920)) nSubsidyBase = 8;
            if ((nPrevHeight >= 2257920) && (nPrevHeight < 2278080)) nSubsidyBase = 7;
            if ((nPrevHeight >= 2278080) && (nPrevHeight < 2298240)) nSubsidyBase = 6;
            if ((nPrevHeight >= 2298240) && (nPrevHeight < 2318400)) nSubsidyBase = 5;
            if ((nPrevHeight >= 2318400) && (nPrevHeight < 2338560)) nSubsidyBase = 4;
            if ((nPrevHeight >= 2338560) && (nPrevHeight < 2358720)) nSubsidyBase = 3;
            if ((nPrevHeight >= 2358720) && (nPrevHeight < 2378880)) nSubsidyBase = 2;
            if ((nPrevHeight >= 2378880)) nSubsidyBase = 1;
    }
