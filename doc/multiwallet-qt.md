...
Only requiring some minor changes is vishai.cpp.
...
Changes to vishai.cpp
----------------------
vishai.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
