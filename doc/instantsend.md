...
This mechanism has been integrated into Bitcore-Node-Vishai which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/vishcoin/insight-api-vishai#web-socket-api](https://github.com/vishcoin/insight-api-vishai#web-socket-api)
* API: [https://github.com/vishcoin/insight-api-vishai#instantsend-transactions](https://github.com/vishcoin/insight-api-vishai#instantsend-transactions)
...
By default, the Vishai Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Vishai Core daemon:
