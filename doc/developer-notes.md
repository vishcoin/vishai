...
Vishai Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Vishai Core, where everyone uses
...
pay attention to for reviewers of Vishai Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Vishai Core uses tinyformat, which is type safe. Leave them out to avoid confusion
